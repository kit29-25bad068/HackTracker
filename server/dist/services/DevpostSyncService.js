...
exports.DevpostSyncService = void 0;
const client_1 = require("@prisma/client");
const TrustScoreService_1 = require("./TrustScoreService");
const BadgeEngine_1 = require("./BadgeEngine");
const prisma = new client_1.PrismaClient();
class DevpostSyncService {
    /**
     * Sync projects from Devpost / GitHub / External profile
     */
    static async syncDevpostProfile(userId, devpostUrl) {
     ...
     */
    static async syncGitHubProfile(userId, githubUsername) {
        const repos = [
...
exports.DevpostSyncService = DevpostSyncService;
