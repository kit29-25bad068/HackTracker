...
export interface SendNotificationParams {
  ...
  message: string;
  link?: string;
  emailCategory?: 'PROJECT_VERIFICATION' | 'RANK_CHANGES' | 'ACHIEVEMENTS' | 'TEAM_UPDATES' | 'DEADLINES' | 'RECOMMENDATIONS';
  emailSubject?: string;
  emailHtml?: string;
}
