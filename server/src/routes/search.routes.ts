...
router.delete('/recent', requireAuth, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const userId = req.user.id;
...
router.post('/saved', requireAuth, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const userId = req.user.id;
...
router.delete('/saved/:id', requireAuth, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
